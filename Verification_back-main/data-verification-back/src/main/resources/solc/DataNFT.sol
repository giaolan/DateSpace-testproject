    ...
    ERC721Burnable
{
    ...
    function sellToken(uint256 tokenId, uint256 price,uint8 type,uint256 duration) public {
        require(
            ownerOf(tokenId) == msg.sender,
    ...
    function buyToken(uint256 tokenId) public payable {
        ...
        // 如果为出租，在到期后自动返回原账户
        if(_allTokensOnSale[index].type == 0){
