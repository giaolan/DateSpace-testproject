export const route = [
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                name: '一级确权',
                path: 'FirstAuthen',
                component: () => import('../components/FirstAuthen.vue')
            },
            {
                name: '二级确权',
                path: 'SecondAuthen',
                component: () => import('../components/SecondAuthen.vue')
            }
        ]
    },
    {
    ...
    {
        name: '出售详情',
        route: '/dataDetail/:id/:type',    // type: 0-数据 1-代币
    ...
    {
        name:'特殊数据出售详情',
        route:'/specialData/:id/:type',
        component:'SpecialDataView',
        meta:{
            requiresAuth:true,
        }
    },
...
export const tjDistrict = [
    {
        name: '和平区',
        value: [117.200983, 39.084158],
        symbolSize: 10,
        itemStyle: {
            normal: {
                color: '#F58158',
...
export const phonePrefix = [
    ...
    '159', '166', '171', '172', '173', '175', '176', '177', '178', '180',
